...
namespace {
    ...
    class Notifynder extends \Fenos\Notifynder\Facades\Notifynder{
         ...
         * @static 
         */
        public static function updateCategory($updates, $categoryId){
            return \Fenos\Notifynder\NotifynderManager::updateCategory($updates, $categoryId);
        }
         ...
         * @static 
         */
        public static function sendGroup($groupName, $info = array()){
            return \Fenos\Notifynder\NotifynderManager::sendGroup($groupName, $info);
        }
         ...
         * @static 
         */
        public static function readOne($notificationId){
            return \Fenos\Notifynder\NotifynderManager::readOne($notificationId);
        }
         ...
         * @static 
         */
        public static function readLimit($toId, $numbers, $order = 'ASC'){
            return \Fenos\Notifynder\NotifynderManager::readLimit($toId, $numbers, $order);
        }
         ...
         * @static 
         */
        public static function readAll($toId){
            return \Fenos\Notifynder\NotifynderManager::readAll($toId);
        }
        ...
        public static function delete($notificationId){
            return \Fenos\Notifynder\NotifynderManager::delete($notificationId);
        }
         ...
         * @static 
         */
        public static function deleteLimit($toId, $number, $order = 'ASC'){
            return \Fenos\Notifynder\NotifynderManager::deleteLimit($toId, $number, $order);
        }
         ...
         * @static 
         */
        public static function deleteAll($toId){
            return \Fenos\Notifynder\NotifynderManager::deleteAll($toId);
        }
         ...
         * @static 
         */
        public static function deleteByCategory($categoryName, $expired = false){
            return \Fenos\Notifynder\NotifynderManager::deleteByCategory($categoryName, $expired);
        }
         ...
         * @static 
         */
        public static function getNotRead($toId, $limit = null, $paginate = null, $order = 'desc', $filterScope = null){
            return \Fenos\Notifynder\NotifynderManager::getNotRead($toId, $limit, $paginate, $order, $filterScope);
        }
         ...
         * @static 
         */
        public static function getAll($toId, $limit = null, $paginate = null, $order = 'desc', $filterScope = null){
            return \Fenos\Notifynder\NotifynderManager::getAll($toId, $limit, $paginate, $order, $filterScope);
        }
         ...
         * @static 
         */
        public static function countNotRead($toId, $filterScope = null){
            return \Fenos\Notifynder\NotifynderManager::countNotRead($toId, $filterScope);
        }
         ...
         * @static 
         */
        public static function findNotificationById($notificationId){
            return \Fenos\Notifynder\NotifynderManager::findNotificationById($notificationId);
        }
         ...
         * @static 
         */
        public static function getLastNotification($toId, $category = null, $filterScope = null){
            return \Fenos\Notifynder\NotifynderManager::getLastNotification($toId, $category, $filterScope);
        }
         ...
         * @static 
         */
        public static function addCategoryToGroupByName($groupName, $categoryName){
            return \Fenos\Notifynder\NotifynderManager::addCategoryToGroupByName($groupName, $categoryName);
        }
         ...
         * @static 
         */
        public static function addCategoryToGroupById($groupId, $categoryId){
            return \Fenos\Notifynder\NotifynderManager::addCategoryToGroupById($groupId, $categoryId);
        }
         ...
         * @static 
         */
        public static function fire($key, $categoryName, $values = array()){
            return \Fenos\Notifynder\NotifynderManager::fire($key, $categoryName, $values);
        }
         ...
         * @static 
         */
        public static function dispatchWith($customSenderName){
            return \Fenos\Notifynder\NotifynderManager::dispatchWith($customSenderName);
        }
        ...
        public static function refresh(){
            //Method inherited from \Fenos\Notifynder\Builder\NotifynderBuilder            
            return \Fenos\Notifynder\NotifynderManager::refresh();
        }
         ...
         * @static 
         */
        public static function setBuilderData($field, $data){
            //Method inherited from \Fenos\Notifynder\Builder\NotifynderBuilder            
            return \Fenos\Notifynder\NotifynderManager::setBuilderData($field, $data);
        }
         ...
         * 
         *
         * @param \Fenos\Notifynder\Builder\Repository $config
         * @static 
         */
        public static function setConfig($config){
            //Method inherited from \Fenos\Notifynder\Builder\NotifynderBuilder            
            return \Fenos\Notifynder\NotifynderManager::setConfig($config);
        }
        ...
        public static function getRequiredFields(){
            //Method inherited from \Fenos\Notifynder\Builder\NotifynderBuilder            
            return \Fenos\Notifynder\NotifynderManager::getRequiredFields();
        }
